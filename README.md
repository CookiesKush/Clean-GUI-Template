...
## Requirements
You need to delete the Remember me label and checkbox, as I have previously stated this is a very simple auth version so it does not have a rememeber me function yet, Go to line 78 in the "FrmLogin.cs" file to change the username and password. You also need Visual Studio 2019 not 2022
...
(1). Left click on project than Add => Reference 
